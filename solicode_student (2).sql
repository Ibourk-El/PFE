...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2024 at 08:44 AM
...
INSERT INTO `access_token` (`student_id`, `token`, `start_time`, `end_time`) VALUES
(21, '39ce2c79d49d53d3f9ed7cb12f55d0ba', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(21, 'fcda9a0810caf8d558df1c120066a301', '2024-04-25 06:22:38', '2024-04-25 07:22:38');
...
(45, 8, 'inDoing', 1, ''),
(47, 8, 'done', 2, ''),
(47, 1, 'notStart', 5, NULL),
(48, 1, 'inDoing', 6, NULL),
(49, 1, 'Done', 7, NULL),
(51, 1, 'notStart', 8, NULL),
(50, 1, 'notStart', 9, NULL),
(52, 1, 'notStart', 10, NULL),
(47, 8, 'notStart', 11, NULL),
(48, 8, 'inDoing', 12, NULL),
(49, 8, 'Done', 13, NULL),
(51, 8, 'notStart', 14, NULL),
(50, 8, 'done', 15, NULL),
(52, 8, 'inDoing', 16, NULL),
(47, 21, 'notStart', 17, NULL),
(48, 21, 'inDoing', 18, NULL),
(49, 21, 'Done', 19, NULL),
(51, 21, 'inDoing', 20, ''),
(50, 21, 'done', 21, NULL),
(52, 21, 'inDoing', 22, NULL);
...
--
ALTER TABLE `access_token`
  ADD CONSTRAINT `access_token_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`);
